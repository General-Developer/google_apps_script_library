...
import 'package:supabase_gas/fork/gotrue/src/constants.dart';
import 'package:supabase_gas/fork/gotrue/src/fetch.dart';
...
void main() {
  group('GotrueFetch', () {
    ...
    test('without API version and weak password error code with payload', () async {
      final client = MockedHttpClient(
        {
          'code': 400,
          'msg': 'error_message',
    ...
    test('without API version, no error code and weak_password payload', () async {
      final client = MockedHttpClient(
        {
          'msg': 'error_message',
          'weak_password': {
