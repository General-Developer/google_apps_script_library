...
import 'package:supabase_gas/fork/gotrue/gotrue.dart';
import 'package:supabase_gas/fork/gotrue/src/types/error_code.dart';
...
void main() {
  ...
  group('Client with default http client', () {
    ...
    test('signUp() with weak password throws AuthWeakPasswordException', () async {
      try {
    ...
    test('Set session with an empty refresh token throws AuthSessionMissingException', () async {
      try {
  ...
  group('Client that fails on the first 3 requests', () {
    ...
    test('Session recovery succeeds after retries', () async {
      try {
        await client.recoverSession('{"access_token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..0x1rFlPKbIU1rZPY1SH_FNSZaXerfkFA1Y-EOlhuzUs","expires_in":3600,"refresh_token":"-yeS4omysFs9tpUYBws9Rg","token_type":"bearer","provider_token":null,"provider_refresh_token":null,"user":{"id":"4d2583da-8de4-49d3-9cd1-37a9a74f55bd","app_metadata":{"provider":"email","providers":["email"]},"user_metadata":{"Hello":"World"},"aud":"","email":"fake1680338105@email.com","phone":"","created_at":"2023-04-01T08:35:05.208586Z","confirmed_at":null,"email_confirmed_at":"2023-04-01T08:35:05.220096086Z","phone_confirmed_at":null,"last_sign_in_at":"2023-04-01T08:35:05.222755878Z","role":"","updated_at":"2023-04-01T08:35:05.226938Z"},"expiresAt":1680341705}');
      } on ClientException {
